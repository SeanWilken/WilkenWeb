...
var CONFIG = {
    ...
    fsharpEntry: './src/Client/Client.fsproj', // app project file w/ 'file dir'
    scssEntry: 'src/Client/styles/styles.scss', // path to main stylesheet
...
//https://stackoverflow.com/questions/41958586/unable-to-hmr-hot-module-replacement-css-scss-with-webpack-2-2-0-and-webpack-d
...
module.exports = {
    ...
    entry: {
        app: resolve(CONFIG.fsharpEntry), // entry point to app
        style: resolve(CONFIG.scssEntry) // entry point to scss
    },
    ...
    // WE NEED TO BETTER UNDERSTAND THAT MINICSS
    // PRODUCTION
    ...
    plugins: isProduction ?
        commonPlugins.concat([
            new MiniCssExtractPlugin({ filename: 'style.[name].[hash].css' }), //outputs style files as mini with filename
