...
let indexTile imgSrc webAppSection descrip dispatch =
    ...
    Tile.parent [ Tile.Size Tile.Is4; Tile.IsVertical ] [
    ...
    div [ ClassName "generalContentCard"; Style [ Padding "50px"; Color "#fff"] ] [
        ...
        Tile.ancestor [] [
            Tile.parent [Tile.IsVertical] [
                ...
                Tile.parent [] [
                    indexTile "./imgs/Harlot.jpeg" ( SharedWebAppViewSections.AboutAppView ) "Learn more about the site and it's purpose." dispatch 
                    indexTile "./imgs/Backstabber.jpeg" ( SharedWebAppViewSections.PortfolioAppCodeView ) "Check out some mini games or code gists." dispatch
                    indexTile "./imgs/Out for Blood.jpeg" ( SharedWebAppViewSections.PortfolioAppDesignView ) "Check out some drawings I've done recently." dispatch
                ]
            ]
        ]
    ]
